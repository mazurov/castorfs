...
%defattr(-,root,root,-)
%{prefix}/bin/castorfs
%{prefix}/share/man/castorfs.1.gz
...
%files -n castorfs
%defattr(-,root,root,-)
%prefix/bin/mount-castorfs-readonly
...
"
    ...
    ELSE ("${ARGV1}" STREQUAL "")
	    ...
	    IF ("${SPECFILE_EXT}" STREQUAL ".spec")
	      ...
	      CONFIGURE_FILE(${SPECFILE_PATH} ${RPM_ROOTDIR}/SPECS/${SPECFILE_NAME} COPYONLY)
	    ELSE ("${SPECFILE_EXT}" STREQUAL ".spec")
	      ...
	      CONFIGURE_FILE(${SPECFILE_PATH} ${RPM_ROOTDIR}/SPECS/${SPECFILE_NAME})
